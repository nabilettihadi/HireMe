...
<body>
            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="relative">
                    ...
                    @if (auth()->user()->company && auth()->user()->company->logo)
                        <!-- Image de profil -->
                        <img src="{{ asset('images/' . auth()->user()->company->logo) }}" alt="Profile Image"
                            class="hidden absolute top-full right-0 transform translate-x-1/2 -translate-y-1/2 bg-white border border-gray-300 shadow-lg rounded-full w-10 h-10">
                    @endif
                </div>
            </div>
        </div>
    ...
    <footer class="bg-gray-900 text-white py-4">
        <div class="container mx-auto">
            <p class="text-center">Contactez-nous: <a href="mailto:{{ auth()->user()->email }}"
                    class="underline">{{ auth()->user()->email }}</a></p>
        </div>
    </footer>
